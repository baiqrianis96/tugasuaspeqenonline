...
<nav class="navbar navbar-default">
	<div class="container-fluid">
		<a class="navbar-brand" href="#"><b>PeQen Online</b></a>
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown <?php if($controller == 'barang') { echo 'active'; } ?>">
					...
					<ul class="dropdown-menu">
						...
						<li role="separator" class="divider"></li>
						<li><a href="<?php echo site_url('barang/list_merek'); ?>">List Merek</a></li>
						<li><a href="<?php echo site_url('barang/list_kategori'); ?>">List Kategori</a></li>
					</ul>
				</li>
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li role="separator" class="divider"></li>
						<li><a href="<?php echo site_url('login/logout'); ?>"><i class='fa fa-sign-out fa-fw'></i> Log Out</a></li>
					</ul>
				</li>
			</ul>
		</div>
